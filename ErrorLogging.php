...
define( "bg_sort_table_LOG_FILE_NAME", plugin_dir_path(__FILE__) . "/bg_sort_table_log_file.log");

/* TODO: Take care of big log files */
/* TODO: Implement time stamps */

class bg_sort_table_LogFile {
	...
	private $_logFileName = bg_sort_table_LOG_FILE_NAME;
